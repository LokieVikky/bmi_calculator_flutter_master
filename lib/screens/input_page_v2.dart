...
class InputPageV2 extends StatefulWidget {
  @override
  _InputPageV2State createState() => _InputPageV2State();
}

class _InputPageV2State extends State<InputPageV2> {
  int height = 180;
  int weight = 60;
  int age = 20;
                ...
                return isLoading
                    ...
                    : BottomButton(
                        ...
                        onTap: () async {
                          ...
                          LoginResModel response = await httpServicepost<LoginResModel>(
